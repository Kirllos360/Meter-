...
describe('POST /meters/{meterId}/assign (assignMeter)', () => {
  ...
  describe('Request schema validation', () => {
    ...
    it('should validate a valid MeterAssignRequest', () => {
      const spec = loadContract();
      const schemas = (spec.components as Record<string, unknown>).schemas as Record<string, unknown>;
      const result = validateResponseBody(schemas.MeterAssignRequest as Record<string, unknown>, validBody);
    ...
    it('should accept optional reason field in MeterAssignRequest', () => {
      ...
      const spec = loadContract();
      const schemas = (spec.components as Record<string, unknown>).schemas as Record<string, unknown>;
      const result = validateResponseBody(schemas.MeterAssignRequest as Record<string, unknown>, bodyWithReason);
      expect(result.valid).toBe(true);
    });
